...
export const About: React.FC<AboutProps> = ({ onOpenGalleryItem }) => {
  ...
  return (
    <section id="about" className="py-16 sm:py-20 bg-[#FBF9F5] border-b border-[#EBE5DB]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6">
            <div className="relative">
              {/* Main Photo Card */}
              <div className="rounded-2xl overflow-hidden border-2 border-[#E5DFD4] shadow-md bg-white">
                <div className="relative aspect-4/3 w-full bg-[#1C201E] overflow-hidden">
                  <img
                  ...
                  <div className="absolute top-4 left-4 bg-[#1C201E]/85 backdrop-blur-xs text-white text-xs font-semibold px-3 py-1.5 rounded-lg border border-white/20 flex items-center space-x-1.5">
                  ...
                  <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/85 via-black/40 to-transparent p-4 text-white">
                    ...
                    <p className="text-xs text-[#D1C7BA] flex items-center mt-0.5">
                ...
                <div className="p-4 bg-[#F7F4EE] border-t border-[#E8E1D5] flex items-center justify-between">
                  <div className="flex items-center space-x-2 text-xs text-[#5D554B]">
                  ...
                  {onOpenGalleryItem && (
                    <button
                      ...
                      className="text-xs font-semibold text-[#C2410C] hover:text-[#9A3412] inline-flex items-center space-x-1"
                    >
              ...
              {/* Decorative small quote card */}
              <div className="absolute -bottom-6 -right-3 sm:-right-6 bg-white rounded-xl shadow-md border border-[#E0D8CB] p-3.5 max-w-[220px] hidden sm:block">
                <div className="flex items-center space-x-1.5 text-xs font-bold text-[#1C201E] mb-1">
                  <Sparkles className="w-3.5 h-3.5 text-[#F59E0B]" />
                  <span>Local Favorite</span>
                </div>
                <p className="text-[11px] text-[#696054] leading-snug">
          ...
          <div className="lg:col-span-6 flex flex-col space-y-6">
            ...
            <p className="text-sm sm:text-base text-[#524B42] leading-relaxed">
            ...
            <div className="pt-2">
              <h3 className="text-xs font-bold uppercase tracking-wider text-[#73695C] mb-3">
                Dining Offerings & Amenities
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {features.map((feat, idx) => (
                  <div key={idx} className="flex items-start space-x-2.5 p-2 rounded-lg bg-white/70 border border-[#EBE4D8]">
                    <div className="w-5 h-5 rounded-full bg-[#ECFDF5] text-[#16A34A] flex items-center justify-center flex-shrink-0 mt-0.5">
                      <Check className="w-3.5 h-3.5" />
                    </div>
                    <div>
                      <p className="text-xs font-bold text-[#1C201E] leading-tight">{feat.name}</p>
                      <p className="text-[11px] text-[#6E6457] leading-tight mt-0.5">{feat.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="flex flex-wrap items-center gap-3 pt-3">
              <div className="inline-flex items-center space-x-1.5 text-xs font-semibold px-3 py-1.5 rounded-lg bg-[#F2ECE1] text-[#423A30]">
                <Clock className="w-3.5 h-3.5 text-[#C2410C]" />
                <span>Open Daily: 12:00 PM – 2:00 AM</span>
              </div>
              <div className="inline-flex items-center space-x-1.5 text-xs font-semibold px-3 py-1.5 rounded-lg bg-[#FEF3C7] text-[#92400E]">
